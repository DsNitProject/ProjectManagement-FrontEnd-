                ...
                <ul className="flex space-x-6">
                  {!successMessage ? (
                    <>
                      ...
                      <li className="flex items-center text-lg font-bold mr-6">
                        <img src={MyImage2} alt="Project Icon" className="w-8" />
                        <a href="/projectCreate" className="mt-3 ml-1">
                          Project Create
                        </a>
                      </li>
                    </>
                    ...
                    <li className="flex items-center text-lg font-bold mr-6">
                      <img src={MyImage3} alt="Project Icon" className="w-7" />
                      <a href='/project' className="mt-3 ml-1">
                        Project
                      </a>
                    </li>
                  )}
